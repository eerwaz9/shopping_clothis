...
import 'package:clothis/users/item/item_details_screen.dart';
import 'package:clothis/users/item/search_items.dart';
...
class HomeFragmentScreen extends StatelessWidget {
  ...
  Future<List<Clothes>> getTrendingClothItems() async{
    ...
    try{
     var res = await http.get(Uri.parse(API.getRatedClothes),);
    ...
    try{
      ...
      if(res.statusCode == 200){
        ...
        if(responseBodyOfAllItems["success"]==true){
          for (var eachRecord in (responseBodyOfAllItems["clothItemsData"] as List)) {
                ...
                itemCount: dataSnapShot.data!.length,
                  ...
                  itemBuilder: (context, index){
                    ...
                    return GestureDetector(
                      onTap: (){
                    (ItemDetailsScreen(itemInfo: eachClothItemData));
                          ...
                          children: [
                            ...
                            ClipRRect(
                              borderRadius: const BorderRadius.only(
                                ...
                                image: NetworkImage(
                                  "${API.HOST_PATH}/items/image/dd/${eachClothItemData.image}",
                                ),
                      ...
                      children: [
                        ...
                        ClipRRect(
                          ...
                          FadeInImage(
                            ...
                            placeholder: const AssetImage("images/place_holder.png"),
                            image: NetworkImage(
                              "${API.HOST_PATH}/items/image/dd/${eachClothItemRecord.image}",
                            ),
