import 'dart:convert';
import 'package:clothis/admin/admin_upload_items.dart';
import 'package:clothis/api/api_connect.dart';
import 'package:clothis/users/authentication/login_screen.dart';
...
Navigator.pushReplacement(context,MaterialPageRoute(builder: (context) =>const AdminUploadItemsScreen() ));
